            ...
            <div className="container px-4 mx-auto">
                <div className="max-w-xl lg:max-w-6xl mx-auto">
                    <div className="flex flex-wrap -mx-4 mb-12">
                        <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
                            <div className="lg:w-112">
                                <a className="relative group block mb-6 h-112 w-full bg-blueGray-900 rounded-md" href="#">
                                    <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                        <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src="shopal-assets/product-details/product-detail-large.png" alt="">
                                    </div>
                                </a>
                                <div className="flex flex-wrap -mx-3 -mb-3 justify-between">
                                    <div className="w-1/2 xs:w-1/4 px-3 mb-3">
                                        <a className="relative group block h-24 w-full bg-blueGray-900 rounded-md" href="#">
                                            <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                                <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src="shopal-assets/product-details/product-detail-small1.png" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <div className="w-1/2 xs:w-1/4 px-3 mb-3">
                                        <a className="relative group block h-24 w-full bg-blueGray-900 rounded-md" href="#">
                                            <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                                <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src="shopal-assets/product-details/product-detail-small2.png" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <div className="w-1/2 xs:w-1/4 px-3 mb-3">
                                        <a className="relative group block h-24 w-full bg-blueGray-900 rounded-md" href="#">
                                            <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                                <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src="shopal-assets/product-details/product-detail-small3.png" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <div className="w-1/2 xs:w-1/4 px-3 mb-3">
                                        <a className="relative group block h-24 w-full bg-blueGray-900 rounded-md" href="#">
                                            <div className="absolute top-0 left-0 h-full w-full transform -translate-y-1 -translate-x-1 group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                                <img className="img-fluid w-full h-full object-cover rounded-md border-2 border-black" src="shopal-assets/product-details/product-detail-small4.png" alt="">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="w-full lg:w-1/2 px-4">
                            <div className="max-w-lg">
                                ...
                                <span className="block text-2xl font-black text-green-500 mb-4">$ 199.00</span>
                                        ...
                                        <a className="group relative inline-block h-12 w-full -mb-2 bg-blueGray-900 rounded-md" href="#">
                                            <div className="absolute top-0 left-0 transform -translate-y-1 -translate-x-1 w-full h-full group-hover:translate-y-0 group-hover:translate-x-0 transition duration-300">
                                                <div className="flex h-full w-full items-center justify-center bg-green-600 border-2 border-black rounded-md">
                                                    <span className="text-base font-black text-black">Add to Cart</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div>
                                    <a className="inline-block text-green-500 hover:text-indigo-500 mr-6" href="#">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <mask id="mask0_601_10113" style="mask-type:alpha" maskunits="userSpaceOnUse" x="7" y="3" width="10" height="18">
                                    ...
                                    <a className="inline-block text-green-500 hover:text-indigo-500 mr-6" href="#">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <mask id="mask0_601_10114" style="mask-type:alpha" maskunits="userSpaceOnUse" x="3" y="4" width="19" height="16">
                                    ...
                                    <a className="inline-block text-green-500 hover:text-indigo-500 mr-6" href="#">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <mask id="mask0_601_10115" style="mask-type:alpha" maskunits="userSpaceOnUse" x="2" y="2" width="20" height="20">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.6007 2.18176H16.3992C19.3874 2.18176 21.8184 4.61276 21.8182 7.60069V16.3992C21.8182 19.3871 19.3874 21.8181 16.3992 21.8181H7.6007C4.61276 21.8181 2.18188 19.3872 2.18188 16.3992V7.60069C2.18188 4.61276 4.61276 2.18176 7.6007 2.18176ZM16.3993 20.0759C18.4267 20.0759 20.0761 18.4266 20.0761 16.3992H20.076V7.60069C20.076 5.57343 18.4266 3.924 16.3992 3.924H7.6007C5.57343 3.924 3.92412 5.57343 3.92412 7.60069V16.3992C3.92412 18.4266 5.57343 20.076 7.6007 20.0759H16.3993ZM6.85721 12.0001C6.85721 9.16418 9.16425 6.85709 12.0001 6.85709C14.8359 6.85709 17.1429 9.16418 17.1429 12.0001C17.1429 14.8358 14.8359 17.1428 12.0001 17.1428C9.16425 17.1428 6.85721 14.8358 6.85721 12.0001ZM8.62805 11.9999C8.62805 13.8592 10.1408 15.3718 12.0001 15.3718C13.8593 15.3718 15.3721 13.8592 15.3721 11.9999C15.3721 10.1405 13.8594 8.62784 12.0001 8.62784C10.1407 8.62784 8.62805 10.1405 8.62805 11.9999Z" fill="white"></path>
                                            </mask>
                                        </svg>
                                    </a>
                                    <a className="inline-block text-green-500 hover:text-indigo-500" href="#">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="mb-8 border-b-2 border-black">
                        <div className="flex flex-col md:flex-row -mb-px"><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-black text-indigo-500 border-b-4 border-indigo-500" href="#">Description</a><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-bold text-black" href="#">Customer Reviews</a><a className="inline-block px-2 pb-2 mb-3 md:mb-0 text-lg font-bold text-black" href="#">Shipping &amp; Returns</a></div>
                    </div>
                    <div>
